...
environ["_GRADING_SCRIPT"] = 'cat oof.json #' #'bundle exec rspec --format json'
environ["_ENTRY_FILE"] = ' ' # rspec will do everything for us, no need to specify a specific file
